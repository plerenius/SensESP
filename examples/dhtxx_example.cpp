...
ReactESP app([] () {
  ...
  auto* pDHTtemperature = new DHTvalue(pDHTxx, temperature, read_delay, "Outside/Temperature");
      
      pDHTtemperature->connectTo(new SKOutputNumber("environment.outside.temperature"));


  // Do the same for the humidity value.
  auto* pDHThumidity = new DHTvalue(pDHTxx, humidity,  read_delay, "Outside/Humidity");
